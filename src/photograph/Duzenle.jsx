    ...
    return (
        <div className={` mt-4 flex flex-col`}>
            ...
            <span class="inline-grid grid-cols-3 gap-3 mt-4 place-content-center place-items-center mx-5">
                ...
                <span className={` border-8 border-[#F2F4F7] w-[72px] h-[72px] place-items-center flex place-content-center`}>
                    <div className=" border-[#D0D5DD] border w-full h-full place-content-center place-items-center flex">
                        <Panorama />
                    </div>
                </span>
                <span className={`box-border border-r-8 border-l-8 border-t-[16px] border-b-[16px] border-[#F2F4F7] w-[72px] h-[72px] place-items-center flex place-content-center `}>
                    <div className=" border-[#D0D5DD] border w-full h-full place-content-center place-items-center flex">
                        <Panorama />
                    </div>
                </span>
                <span className={`border-[#F2F4F7] box-border border-8 w-[72px] h-[72px] place-items-center flex place-content-center `}>
                    <div className=" border-[#D0D5DD] border w-full h-full place-content-center place-items-center flex">
                        <Panorama />
                    </div>
                </span>
                <span className={`border-[#F2F4F7] box-border border-r-8 border-l-8 border-t-[17px] border-b-[15px] w-[72px] h-[72px] place-items-center flex place-content-center `}>
                    <div className=" border-[#D0D5DD] border w-full h-full place-content-center place-items-center flex">
                        <Panorama />
                    </div>
                </span>
                <span className={`border-[#F2F4F7] box-border border-r-[7px] border-l-[7px] border-t-8 border-b-8 w-[72px] h-[72px] place-items-center flex place-content-center `}>
                    <div className=" border-[#D0D5DD] border w-full h-full place-content-center place-items-center flex">
                        <Panorama />
                    </div>
                </span>
                <span className={` bg-[#F2F4F7] w-[72px] h-[72px] place-items-center flex place-content-center `} >
            ...
            <span class="inline-grid grid-cols-3 gap-3 mt-4 place-content-center place-items-center mx-5">
                <span className={`box-border border-l-[9px] border-r-[9px] border-t-[18.5px] border-b-[18.5px] border-[#F2F4F7] w-[72px] h-[72px] place-items-center flex place-content-center `}>
                    <div className=" border-[#D0D5DD] border w-full h-full place-content-center place-items-center flex">
                        <Block />
                    </div>
                </span>
                <span className={` border-[9px] border-r-[9px] border-t-[18.5px] border-b-[18.5px] border-[#F2F4F7] w-[72px] h-[72px] place-items-center flex place-content-center`}>
                    <div className=" border-[#D0D5DD] border w-full h-full place-content-center place-items-center flex">
                        <Panorama_2 />
                    </div>
                </span>
