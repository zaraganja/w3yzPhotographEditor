...
import  {ReactComponent as Arkaplan} from '../assets/icons/arkaplan.svg';
                    ...
                    <div className={`h-1/5 justify-center justify-items-center  overflow-hidden `}>
                        ...
                        <ul className={`flex flex-row justify-between align-middle overflow-hidden mt-10 bg-white px-96`}>
                            <div  className={` flex flex-col place-content-center self-center overflow-hidden place-items-center`} >
                                ...
                                <button className={` pt-2 hover:text-gray-600 text-pop60016 ${OnCropSelect ? `text-[#1D2939]` : `text-[#888888] `}  `}>Düzenle</button>
                            </div>
                            <div className={` flex flex-col place-content-center self-center overflow-hidden place-items-center`}>
                                <Arkaplan fill={OnBackgroundSelect ? '#1D2939' : '#888888' } />
                                <button className={` pt-2 hover:text-gray-600 text-pop60016 ${OnBackgroundSelect ? `text-[#1D2939]` : `text-[#888888]`}`}>Arka Plan </button>
                            </div>
                            <div className={` flex flex-col place-content-center self-center overflow-hidden place-items-center`}>
                                <Colors fill={OnColorsSelect ? '#1D2939' : '#888888' } />
                                <button className={` pt-2 hover:text-gray-600 text-pop60016 ${OnColorsSelect ? `text-[#1D2939]` : `text-[#888888]`}   `}>Renk Ayarları</button>
                            </div>
                            <div className={` flex flex-col place-content-center self-center overflow-hidden place-items-center`}>
                                <TXT fill={OnAddTXTselect ? '#1D2939' : '#888888' } />
                                <button className={` pt-2 hover:text-gray-600 text-pop60016 ${ OnAddTXTselect ? `text-[#1D2939]` : `text-[#888888]`}`}>Metin Ekle</button>
                            </div>
                        </ul>
                    </div>
                </div>
                {/* right menue */}
                <div className={`w-1/6 bg-white border-l border-border-color-0`}>
                    {OnCropSelect ? 
                    <Duzenle/>
                    :
                    <></>
